...
const topicMeta: Record<string, { title: string; color: string; description: string; content: string; tools: Tool[] }> = {
  trading: {
    title: 'Trading & Perps',
    color: '#00ff41',
    ...
    tools: [
      { name: 'Hyperliquid', logo: 'https://pbs.twimg.com/profile_images/2001260078352285697/f5cl2Syx_400x400.jpg', website: 'https://hyperliquid.xyz', x: 'https://twitter.com/HyperliquidX' },
      { name: 'dYdX', logo: 'https://pbs.twimg.com/profile_images/2008063225213128705/te3FgvVh_400x400.png', website: 'https://dydx.trade', x: 'https://twitter.com/dYdX' },
      { name: 'GMX', logo: 'https://pbs.twimg.com/profile_images/1976306246476234752/htrS8yGK_400x400.jpg', website: 'https://gmx.io', x: 'https://twitter.com/GMX_IO' },
      { name: 'Avantis', logo: 'https://pbs.twimg.com/profile_images/1697767684962717696/4teZgPJm_400x400.png', website: 'https://www.avantisfi.com/', x: 'https://x.com/avantisfi' },
    ],
  },
  prediction: {
    ...
    tools: [
      { name: 'Polymarket', logo: 'https://pbs.twimg.com/profile_images/2005664281002491904/bz2ZO_nU_400x400.jpg', website: 'https://polymarket.com', x: 'https://x.com/Polymarket' },
      { name: 'Azuro', logo: 'https://pbs.twimg.com/profile_images/1749775832971649024/gclHWoGh_400x400.jpg', website: 'https://azuro.org', x: 'https://x.com/azuroprotocol' },
      { name: 'Kalshi', logo: 'https://pbs.twimg.com/profile_images/2026716397598867456/cTZJLMxV_400x400.jpg', website: 'https://kalshi.com', x: 'https://x.com/Kalshi' },
    ],
  },
  defi: { 
    title: 'DeFi',
    ...
    tools: [
      { name: 'Uniswap', logo: 'https://pbs.twimg.com/profile_images/1831348758753206272/y2Z0hMrl_400x400.jpg', website: 'https://uniswap.org', x: 'https://twitter.com/Uniswap' },
      { name: 'Aave', logo: 'https://pbs.twimg.com/profile_images/1808921860781821952/CmtvkzWo_400x400.png', website: 'https://aave.com', x: 'https://twitter.com/aave' },
      { name: 'Curve', logo: 'https://pbs.twimg.com/profile_images/1220560374346461185/W1sQNVWo_400x400.jpg', website: 'https://curve.fi', x: 'https://twitter.com/CurveFinance' },
      { name: 'Jupiter Exchange', logo: 'https://pbs.twimg.com/profile_images/1944921381168099328/mVkHxhxy_400x400.jpg', website: 'https://jup.ag/', x: 'https://x.com/JupiterExchange' },
    ],
  },
  memes: {
    title: 'Memes & NFTs',
  ...
  ai: {
    ...
    tools: [
      { name: 'Virtuals', logo: 'https://pbs.twimg.com/profile_images/2009228951621914626/U6ZpmYq3_400x400.jpg', website: 'https://virtuals.io', x: 'https://twitter.com/virtuals_io' },
      { name: 'Bnkr', logo: 'https://pbs.twimg.com/profile_images/1951545493936545792/AriqgxQN_400x400.jpg', website: 'https://bankr.bot', x: 'https://x.com/bankrbot' },
      { name: 'Moltbook', logo: 'https://pbs.twimg.com/profile_images/2029238735750217730/RBH3J4E2_400x400.jpg', website: 'https://moltbook.com', x: 'https://x.com/moltbook' },
      { name: 'OpenAI', logo: 'https://pbs.twimg.com/profile_images/2018105896753065984/HwVbSo2x_400x400.jpg', website: 'https://fomolt.com/', x: 'https://x.com/fomoltapp' },
    ],
  },
}
